...
CONTAINERD_BIN_AARCH64_SITE = https://github.com/containerd/containerd/releases/download/$(CONTAINERD_BIN_AARCH64_VERSION)
CONTAINERD_BIN_AARCH64_SOURCE = containerd-$(CONTAINERD_BIN_AARCH64_VERSION:v%=%)-linux-amd64.tar.gz
